...
export const pagenationSlice = createSlice({
  ...
  name: 'pagenation',
  reducers: {
    updatePage: (state, action: PayloadAction<{ page: PagenationParamsState['page'] }>) => {
...
export const selectPagenationParams = (state: RootState): PagenationParamsState => state.pagenation
