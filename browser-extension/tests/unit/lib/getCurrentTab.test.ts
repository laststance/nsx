...
describe('getCurrentTab', () => {
  ...
  it('should use fallback when active tab is extension page', async () => {
    ...
    // First call returns extension tab, second call returns all tabs
    ;(chrome.tabs.query as any)
  ...
  it('should return chrome:// tab if it is the active tab', async () => {
    ...
    ;(chrome.tabs.query as any).mockResolvedValueOnce([chromeTab])
  ...
  it('should return about: tab if it is the active tab', async () => {
    ...
    ;(chrome.tabs.query as any).mockResolvedValueOnce([aboutTab])
