...
export const handlers = [
  rest.get('/api/post_list', (req, res: ResponseComposition<Res.PostList>, ctx: RestContext) => {
    return res(
      ctx.json({
        postList: [
          {
          ...
          },
          {
            ...
            id: 53,
            title: 'I was challenged reusable input component with React Hook Form',
          ...
          },
          {
            ...
            id: 49,
            title: 'Hide error within Redux-Toolkit and Redux-persist combination ',
